        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    Authorization = req.cookies["Authorization"] || (req.header("Authorization") ? req.header("Authorization").split("Bearer ")[1] : null);
                    ...
                    return [
                        4,
                        verify(Authorization, secretKey)
                    ];
                case 1:
                    verificationResponse = _state.sent();
