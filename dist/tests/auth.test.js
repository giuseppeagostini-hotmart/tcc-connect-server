...
describe("Testing Auth", function() {
    describe("[POST] /signup", function() {
        it("response should have the Create userData", /*#__PURE__*/ _async_to_generator(function() {
    ...
    describe("[POST] /login", function() {
        it("response should have the Set-Cookie header with the Authorization token", /*#__PURE__*/ _async_to_generator(function() {
            var userData, authRoute, users, _, _1, _tmp, app;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
